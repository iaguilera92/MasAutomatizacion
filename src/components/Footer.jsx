        ...
        {isMobile && (
          <Box display="flex" flexDirection="column" alignItems="center" mb={7}>
            ...
            >
              ...
              <SocialButton href="https://www.linkedin.com/in/mauricio-tapia-alvial-6020602a/" Icon={LinkedInIcon} bgColor="linear-gradient(45deg, #00B5F5, #0077b7)" isMobile={isMobile} />
            </Box>
