...
const iconMap = {
  PrecisionManufacturingIcon: <PrecisionManufacturingIcon fontSize="small" />,
  ShowChartIcon: <ShowChartIcon fontSize="small" />,
  ExtensionIcon: <ExtensionIcon fontSize="small" />,
  BuildIcon: <BuildIcon fontSize="small" />,
  ElectricalServicesIcon: <ElectricalServicesIcon fontSize="small" />,
};
